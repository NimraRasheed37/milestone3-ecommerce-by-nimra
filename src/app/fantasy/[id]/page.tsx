...
const FantasyBookDetail = () => {
  ...
  useEffect(() => {
    const fetchBookDetails = async () => {
      try {
        const response = await fetch(`/api/books/fantasy/${id}`);
  ...
  return (
    <div className="bg-white text-black mx-auto px-6 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col mb-4">
          ...
          <button
              className="bg-red-600 text-white py-2 px-6 rounded-lg hover:bg-black transition duration-300"
              onClick={handleBuyNow}
            >
              Buy Now
            </button>
            <button
              className="text-white bg-black py-2 px-6 border hover:bg-red rounded-lg  transition duration-300"
...
export default FantasyBookDetail;
